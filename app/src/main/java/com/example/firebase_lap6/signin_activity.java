package com.example.firebase_lap6;
        ...
        ahLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(signin_activity.this, "email is not empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(password)) {
                    Toast.makeText(signin_activity.this, "password is not empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(signin_activity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Log.d(TAG, "signInActivity: false");
                            Toast.makeText(signin_activity.this, "Login False", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
